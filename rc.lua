...
run_once(
{ "compton", "nm-applet", "blueman-applet", "megasync", "unclutter -root" })
...
local myawesomemenu = {
    ...
    { "laptopOn", "xrandr --output eDP1 --auto"},
    { "laptopOff", "xrandr --output eDP1 --off"},
    { "monitorOn", "xrandr --output HDMI1 --auto"},
    { "monitorOff", "xrandr --output HDMI1 --off"},
    { "arandr", "arandr"},
...
mylauncher = awful.widget.launcher({ image = iconDir.."laptop.png",
...
awful.screen.connect_for_each_screen(function(s) beautiful.at_screen_connect(s) end)  -- FU!
-- }}}
...
-- Scrot random letters
local function random_string(len)
  local res = {}
  for i=1, len do
    -- from range a-z
    res[i] = string.char(math.random(97, 122)) -- letters
    --res[i] = string.char(math.random(48, 57)) -- numbers
    --res[i] = string.char(math.random(65, 90)) -- capital letters
  end
...
globalkeys = my_table.join(
    ...
    -- Screenshots
    --awful.key({ modkey }, "Print", function () awful.util.spawn("scrot -e 'mv $f ~/p/Screenshots/ 2>/dev/null'", false) end),
    ...
    -- ALSA volume control
    awful.key({ "#123" }, "XF86AudioRaiseVolume",
        function ()
            os.execute(string.format("amixer -q set %s 1%%+", beautiful.volume.channel))
            beautiful.volume.update()
        end,
        {description = "volume up", group = "hotkeys"}),
    awful.key({ "#122" }, "XF86AudioLowerVolume",
        function ()
            os.execute(string.format("amixer -q set %s 1%%-", beautiful.volume.channel))
            beautiful.volume.update()
        end,
        {description = "volume down", group = "hotkeys"}),
    awful.key({ "#121" }, "XF86AudioMute",
        function ()
    ...
    awful.key({ modkey }, "d", function () awful.spawn(fm) end,
              {description = "run fm", group = "launcher"}),
